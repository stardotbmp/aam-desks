...
function Registers() {
    ...
    staffRegister = loadData('https://docs.google.com/spreadsheet/pub?key=0AlktlYt5-E-DdGo1X0RhcDh3TlpWWjIzam5EVGxiQ3c&single=true&gid=0&range=A1&output=txt', 'staff');
